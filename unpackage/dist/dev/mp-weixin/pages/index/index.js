...
//
// 引入css绝对路径
var musichesd = function musichesd() {__webpack_require__.e(/*! require.ensure | components/musichead/musichead */ "components/musichead/musichead").then((function () {return resolve(__webpack_require__(/*! ../../components/musichead/musichead.vue */ 36));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { data: function data() {return { topList: [] };}, // 局部组件
  components: { musichesd: musichesd }, // 等整个页面加载完之后触发的
  onLoad: function onLoad() {var _this = this;(0, _api.topList)().then(function (res) {if (res.length) {_this.topList = res;}});}, methods: { handleTopList: function handleTopList(listId) {uni.navigateTo({ url: '/pages/list/list?listId=' + listId });} } };exports.default = _default;
